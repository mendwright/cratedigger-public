  ...
  const groups: Group[] = [
    {
      ...
      rows: [
        ...
        { keys: [mod, '2'], label: 'New & upcoming' },
        { keys: [mod, '3'], label: 'Shows' },
        { keys: [mod, '4'], label: 'Charts' },
        { keys: [mod, '5'], label: 'Classical' },
        { keys: [mod, '6'], label: 'Playlists' },
    ...
    // Maintenance-only, and gated to match: the friends build ships without
    // these screens, so listing their shortcuts there was just wrong.
    ...(PUBLIC_BUILD
      ? []
      : [
          {
            title: 'Triage & inbox',
            rows: [
              { keys: [mod, 'Shift', '1'], label: 'Inbox' },
              { keys: [mod, 'Shift', '2'], label: 'Triage' },
              { keys: [mod, 'Shift', '3'], label: 'Soulseek' },
              { keys: [mod, 'Shift', '4'], label: 'Art fixer' },
