...
export class SettingsController {
  ...
  async ensureLoaded(): Promise<void> {
    ...
    try {
      ...
      this.autoWarmCredits = s.autoWarmCredits ?? false
    } catch {
      // keep defaults empty
    } finally {
      this.loaded = true
  ...
  async save(args: SettingsPatch): Promise<void> {
    try {
      ...
      if (typeof args.autoWarmCredits === 'boolean') this.autoWarmCredits = args.autoWarmCredits
