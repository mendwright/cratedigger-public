...
<style>
  ...
  .cover-fallback {
    ...
    box-shadow: 0 6px 14px rgba(43, 29, 18, 0.18);
    transition:
  ...
  .card:hover .cover-fallback {
    ...
    box-shadow:
      0 16px 32px rgba(43, 29, 18, 0.32),
  ...
  .format-badge.lossless {
    ...
    border-color: rgba(43, 29, 18, 0.4);
  }
