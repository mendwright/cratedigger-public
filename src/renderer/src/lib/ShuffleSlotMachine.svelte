...
<style>
  ...
  .frame {
    ...
    box-shadow: 0 30px 60px rgba(var(--shadow-color), 0.45), inset 0 0 0 1px rgba(var(--shadow-color), 0.6);
  ...
  .card {
    ...
    box-shadow: 0 16px 36px rgba(var(--shadow-color), 0.28);
  }
  .cover {
  ...
  .card.landed {
    ...
    box-shadow: 0 0 0 2px var(--brick), 0 0 40px color-mix(in srgb, var(--brick) 55.0%, transparent), 0 22px 48px rgba(var(--shadow-color), 0.32);
  ...
  .confirm:hover { background: color-mix(in srgb, var(--brick) 28.0%, transparent); }
  .confirm-artist { color: var(--espresso); }
  .confirm-sep { color: color-mix(in srgb, var(--brick) 60%, transparent); }
  .confirm-title {
    overflow: hidden;
