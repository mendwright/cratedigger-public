...
export interface AppSettings {
  ...
  // Auto-run the library warmer (credits only) until the whole library is cached.
...
export interface IpcInvokeContract {
  ...
  'tagger:get-release': {
    args: [args: { mbid: string; timeoutMs?: number }]
    result: MbCanonicalRelease
  }
