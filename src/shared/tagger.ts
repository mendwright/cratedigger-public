...
export interface MbCanonicalRelease {
  ...
  // Canonical MusicBrainz artist names behind the credit, parallel to
  // albumartist_ids ("The Angels" behind a release credited "Angel City").
  // Optional: older tagger builds don't send it.
  albumartist_names?: string[]
  release_mbid: string
