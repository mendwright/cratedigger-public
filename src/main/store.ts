...
export interface StoreSchema {
  ...
  // Source-set version the genre index was last fully built with (see GENRE_INDEX_TIER).
  genreIndexTier: number
  ...
  // Keep MusicBrainz credits for the entire library cached on this machine:
  // the library warmer starts itself after launch and resumes until every
  // album is on disk, then re-checks for new albums. On by default in the
  // private build; friends opt in (it's hours of polite MB traffic).
  autoWarmCredits: boolean
