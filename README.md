...
Grab the latest DMG from the [Releases](https://github.com/jaybeaman/cratedigger-public/releases) page, drag it to /Applications, open it, and sign in with Plex.
